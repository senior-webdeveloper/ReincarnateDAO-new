...
function Calculator() {
    ...
    stakingAPY > 100000000 ? parseFloat(stakingAPY * 100).toExponential(8) : trim(stakingAPY * 100, 1);
                    ...
                    <Grid className="calculator-card-grid" container direction="column" spacing={2}>
                        <Grid item>
                            <Box className="card-header">
                                ...
                                <Typography variant="body3">Estimate your returns</Typography>
                            </Box>
                        </Grid>
                        <Grid item>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-apy">
                                            <Typography variant="h5" color="textSecondary">HXL Price</Typography>
                                            <Typography variant="h4" style={{fontWeight: "600"}}>{isAppLoading ? <Skeleton width="100px" /> : `$${trimeMarketPrice}`}</Typography>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-tvl">
                                            <Typography variant="h5" color="textSecondary">Current APY</Typography>
                                            <Typography variant="h4" style={{fontWeight: "600", "word-break":"break-all", "white-space":"break-spaces"}}>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-index">
                                            <Typography variant="h5" color="textSecondary">sHXL Balance</Typography>
                                            <Typography variant="h4" style={{fontWeight: "600"}}>{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedsHecBalance} sHXL</>}</Typography>
                                        </Box>
                                    </Grid>
                                </Grid>
                            </Box>
                        ...
                        <Box className="calculator-card-area">
                            <Box>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">sHXL Amount</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">HXL price at purchase ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">Future HXL market price ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                ...
                                <Box className="calculator-user-data">
                                    ...
                                    <Box className="data-row">
                                        <Typography>HXL rewards estimation</Typography>
                                        <Typography>{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} HXL</>}</Typography>
                                    </Box>
                                    <Box className="data-row">

            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sHXL accumulated since the beginning of staking. Basically, how much sHXL one would have if they staked and held a single HXL from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sHXL" : <Skeleton type="text" />}
                </Typography>
              </Box>
              ...
              <Box className="metric bpo">
                ...
                <Typography variant="h5">
                  {circSupply && totalSupply ? (
                      trim(parseInt(circSupply)/parseInt(totalSupply)*100, 1)+"%"
                    ) : (
                      <Skeleton type="text" />
                    )}
                </Typography>
              ...
              {/* <Box className="metric runway">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "Runway, is the number of days sHXL emissions can be sustained at a given rate. Lower APY = longer runway"
                    }
                  />
                </Typography>
                <Typography variant="h5">
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                <Chart
                  ...
                  headerText="Protocol Owned Liquidity HXL-DAI"
